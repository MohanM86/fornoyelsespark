  ...
  return (
    <>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        <Link href="/planlegg-dagstur"><ActionBtn label="Planlegg dagstur" primary icon={<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>} /></Link>
        <Link href="/sammenlign"><ActionBtn label="Sammenlign alle" icon={<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/></svg>} /></Link>
        <Link href="/apningstider"><ActionBtn label="Sjekk åpningstider" icon={<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>} /></Link>
      </div>
