...
export default function CityPage({ params }: Props) {
  ...
  return (
    <>
      ...
      <h1 className="text-xl font-bold mb-2" style={{ color: 'var(--txt)' }}>Fornøyelsesparker i {city.name}</h1>
      <p className="text-[14px] leading-relaxed mb-6" style={{ color: 'var(--txt-s)' }}>{city.description}</p>
      ...
      ) : <Section><p className="text-[13px] py-6 text-center" style={{ color: 'var(--txt-m)' }}>Vi legger til oppføringer for {city.name} snart.</p></Section>}
