  ...
  return (
    <>
      ...
      <article>
        ...
        {city && <Section><Link href={`/${city.slug}`} className="flex items-center rounded-xl p-4" style={{ background: 'var(--card)', border: '1px solid var(--brd)' }}><span className="text-[13px] font-semibold" style={{ color: 'var(--blue)' }}>Alle parker i {city.name} →</span></Link></Section>}
